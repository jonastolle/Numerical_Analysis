...
for all $x,y\in\mathbb{R}$. Then there exists a unique fixed point $x^\ast$ of $\varphi$, and the fixed point iteration $\varphi
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTYyNzU4MjM2OSwtMTY0Nzc3MzQxNSwtMT
