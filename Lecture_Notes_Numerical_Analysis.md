...
>$$K(x)==\frac{x}{2\sqrt{1+x}(\sqrt{1+x}-1)}=\frac{x(\sqrt{1+x}+1)}{2\sqrt{1+x}(\sqrt{1+x}-1)(\sqrt{1+x}+1)}=\frac{\sqrt{1+x}+1}{2\sqrt{1+x}}.$$
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNzUxNDEyMTU3LC0yMTI3MjUwOTYsMTEyOT
