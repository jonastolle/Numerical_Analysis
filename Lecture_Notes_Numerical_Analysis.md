...
Let $(x_k)_{n\in\mathbb{N}}$ be an infinite sequence of real numbers.  Let $s_k:=\sup_{l\ge k}x_l$, $k\in\mathbb{N}$, be the *supremum* (i.e., the lowest upper bound) of the *tail* of $(x_k)$. Define
$$\limsup_{k\to
...
### Newton's method
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE4MDMyNDkzMjcsLTQxNDYxNjAyMCwxMD
gxNTYwMjY1LC0xNTU5MjM4MzgyLC0xMDMwMjk5MzU5LC0xODcw
MTk1NjEzLC0xNTAxMTc5Mjc1LC0xODY3MTc2MTc1XX0=
-->