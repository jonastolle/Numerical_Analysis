...
**Definition.** If $f:\mathbb{R}^n\to\mathbb{R}$, $n\in\mathbb{N}$ is $k$-times continuously differentiable, then we write $f\in C^k(\R^n)$ or just $f\in C
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTAzNzc4NTI0MSwxMDE3ODI5Njc0LC0xMj
